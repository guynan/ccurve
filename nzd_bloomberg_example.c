 ...
 *     NDSF{1..6}A Curncy  — first 6 RBNZ meeting dates (short end)
 *     NDSO{3,4,5,6,7,10,12,15} Curncy — year-tenor NZONIA swaps (long end)
 *
...
int main(int argc, char **argv)
{
    ...
    printf("  OIS: NZONIA  (NDSF1-6A meetings + NDSO3-15 swaps)\n");
